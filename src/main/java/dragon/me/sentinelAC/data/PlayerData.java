package dragon.me.sentinelAC.data;
...
public class PlayerData {
    ...
    public void alert(String name, Object debug, int maxVL) {
        ...
        String prefix = SentinelAC.getPlugin().getConfig().getString("prefix", "&c[Aegis]");
        String alertTemplate = SentinelAC.getPlugin().getConfig().getString("alert_message", "%prefix% %player% failed %check% [%vl%/%max-vl%] // %offset%");
